...
var headers = { headers: { 'User-Agent': 'Mozilla/5.0 (Windows; U; Windows NT 5.1; de; rv:1.9.2.3) Gecko/20100401 Firefox/3.6.3' } }
...
module.exports = function switcher (url, callback) {
  ...
  wreck.request('GET', uri, options, function (error, response, html) {
    if(url.match(/musk/)){
